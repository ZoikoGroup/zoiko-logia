...
Provider adapters (Twelve Data) behind one Protocol, with a registry that picks
a provider per intent and falls back when one is unconfigured or unavailable —
the Protocol keeps the door open to adding more providers without touching
anything downstream. Mirrors the structure of
